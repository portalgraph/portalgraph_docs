...
{% content-ref url="../portalgraph-detail/urp-anaglyph-renderer-configuration-required.md" %}
[urp-anaglyph-renderer-configuration-required.md](../portalgraph-detail/urp-anaglyph-renderer-configuration-required.md)
{% endcontent-ref %}
